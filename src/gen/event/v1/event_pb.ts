...
export class RegisterEventRequest extends Message<RegisterEventRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "reportedTimestamp", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 4, name: "sdkCall", kind: "message", T: SDKCall, oneof: "data" },
  ]);
...
export class StreamEventRequest extends Message<StreamEventRequest> {
  ...
  /**
   * @generated from field: int32 reported_timestamp = 3;
   */
  reportedTimestamp = 0;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "type", kind: "enum", T: proto3.getEnumType(EventType) },
    { no: 2, name: "userId", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "reported_timestamp", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 4, name: "sdkCall", kind: "message", T: SDKCall, oneof: "data" },
    { no: 5, name: "aiTokenUsage", kind: "message", T: AITokenUsage, oneof: "data" },
  ]);
